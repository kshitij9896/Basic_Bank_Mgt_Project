<footer class="page-footer #393444;" id="footer" style="background-color:#393444">
    ...
    <div class="footer-copyright">
        <div class="container hoverable">
            <a class="grey-text text-lighten-4 center-align">
                <p style="letter-spacing: 2px;"><i class="fa fa-code" style="font-size:15px;"></i> with <i class="fa fa-heart" style="font-size:15px;"></i> Kshitij Bansod</p>
            </a>
        </div>
    </div>
</footer>